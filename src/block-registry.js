...
const SPECIAL_FACES = {
  ...
  'chest':                { top: 'oak_planks', side: 'oak_planks', bottom: 'oak_planks' },
  'hopper':               { top: 'hopper_top', side: 'hopper_outside', bottom: 'hopper_inside' },
  'barrel':               { top: 'barrel_top', side: 'barrel_side', bottom: 'barrel_bottom' },
  'composter':            { top: 'composter_top', side: 'composter_side', bottom: 'composter_bottom' },
